...
enum AppTextKey: String {
    ...
    case captureWaitingForSourceAudioFormat
    case captureReconnectingHint
    case capturePermissionProblemHintFormat
    case captureStatusStarting
    case captureStatusHearing
    case captureStatusWaiting
    case captureStatusReconnecting
    case captureStatusPermission
    case openAudioRecordingSettings
    case audioInput
    case listening
    case captureStopped
    case unableToStart
...
enum AppLocalization {
    ...
    private static let tables: [String: [String: String]] = [
        "en": [
            ...
            "subtitleColor": "Translation Color",
            "sourceSubtitleColor": "Original Text Color",
            ...
            "captureWaitingForSourceAudioFormat": "Connected. Waiting for %@ to play sound — start the meeting or unmute the speaker.",
            "captureReconnectingHint": "Audio route changed. Reconnecting…",
            "capturePermissionProblemHintFormat": "No sound from %@ even though it is playing. Allow v2s in System Settings › Privacy & Security › Screen & System Audio Recording, then restart v2s.",
            "captureStatusStarting": "Starting…",
            "captureStatusHearing": "Hearing audio",
            "captureStatusWaiting": "Connected — app is silent",
            "captureStatusReconnecting": "Reconnecting audio…",
            "captureStatusPermission": "No audio — check permission",
            "openAudioRecordingSettings": "Open Audio Recording Settings",
            "audioInput": "Audio",
            "listening": "Listening...",
        ...
        "zh-Hans": [
            ...
            "captureWaitingForSourceAudioFormat": "已连接。正在等待 %@ 播放声音——请开始会议或取消静音。",
            "captureReconnectingHint": "音频路由已变化，正在重新连接…",
            "capturePermissionProblemHintFormat": "%@ 正在播放，但没有采集到声音。请在“系统设置 › 隐私与安全性 › 屏幕与系统音频录制”中允许 v2s，然后重启 v2s。",
            "captureStatusStarting": "正在启动…",
            "captureStatusHearing": "正在接收音频",
            "captureStatusWaiting": "已连接——应用无声音",
            "captureStatusReconnecting": "正在重新连接音频…",
            "captureStatusPermission": "没有音频——请检查权限",
            "openAudioRecordingSettings": "打开音频录制设置",
            "audioInput": "音频",
            "listening": "正在聆听...",
        ...
        "es": [
            ...
            "subtitleColor": "Color de la traducción",
            "sourceSubtitleColor": "Color del texto original",
            ...
            "captureWaitingForSourceAudioFormat": "Conectado. Esperando a que %@ reproduzca sonido: inicia la reunión o activa el altavoz.",
            "captureReconnectingHint": "La ruta de audio cambió. Reconectando…",
            "capturePermissionProblemHintFormat": "%@ está reproduciendo, pero no llega sonido. Permite v2s en Ajustes del Sistema › Privacidad y seguridad › Grabación de pantalla y audio del sistema, y reinicia v2s.",
            "captureStatusStarting": "Iniciando…",
            "captureStatusHearing": "Recibiendo audio",
            "captureStatusWaiting": "Conectado: la app está en silencio",
            "captureStatusReconnecting": "Reconectando audio…",
            "captureStatusPermission": "Sin audio: revisa el permiso",
            "openAudioRecordingSettings": "Abrir ajustes de grabación de audio",
            "audioInput": "Audio",
        ...
        "de": [
            ...
            "subtitleColor": "Übersetzungsfarbe",
            "sourceSubtitleColor": "Farbe des Originaltexts",
            ...
            "captureWaitingForSourceAudioFormat": "Verbunden. Warte, bis %@ Ton abspielt – starte das Meeting oder hebe die Stummschaltung auf.",
            "captureReconnectingHint": "Audioweg geändert. Verbinde neu…",
            "capturePermissionProblemHintFormat": "%@ spielt ab, aber es kommt kein Ton an. Erlaube v2s unter Systemeinstellungen › Datenschutz & Sicherheit › Bildschirm- & Systemaudioaufnahme und starte v2s neu.",
            "captureStatusStarting": "Wird gestartet…",
            "captureStatusHearing": "Audio wird empfangen",
            "captureStatusWaiting": "Verbunden – App ist still",
            "captureStatusReconnecting": "Audio wird neu verbunden…",
            "captureStatusPermission": "Kein Audio – Berechtigung prüfen",
            "openAudioRecordingSettings": "Einstellungen für Audioaufnahme öffnen",
            "audioInput": "Audio",
            "listening": "Hört zu...",
        ...
        "ja": [
            ...
            "captureWaitingForSourceAudioFormat": "接続済み。%@ が音を出すのを待っています。会議を始めるか、スピーカーのミュートを解除してください。",
            "captureReconnectingHint": "音声の経路が変わりました。再接続しています…",
            "capturePermissionProblemHintFormat": "%@ は再生中ですが音が届きません。システム設定 › プライバシーとセキュリティ › 画面とシステムオーディオの録音 で v2s を許可し、v2s を再起動してください。",
            "captureStatusStarting": "開始しています…",
            "captureStatusHearing": "音声を受信中",
            "captureStatusWaiting": "接続済み（アプリは無音）",
            "captureStatusReconnecting": "音声を再接続中…",
            "captureStatusPermission": "音声なし（権限を確認）",
            "openAudioRecordingSettings": "オーディオ録音の設定を開く",
            "audioInput": "音声",
            "listening": "聞き取り中...",
        ...
        "fr": [
            ...
            "subtitleColor": "Couleur de la traduction",
            "sourceSubtitleColor": "Couleur du texte original",
            ...
            "captureWaitingForSourceAudioFormat": "Connecté. En attente du son de %@ : lancez la réunion ou réactivez le haut-parleur.",
            "captureReconnectingHint": "Le routage audio a changé. Reconnexion…",
            "capturePermissionProblemHintFormat": "%@ joue du son, mais rien n'est capté. Autorisez v2s dans Réglages Système › Confidentialité et sécurité › Enregistrement de l'écran et de l'audio système, puis relancez v2s.",
            "captureStatusStarting": "Démarrage…",
            "captureStatusHearing": "Audio reçu",
            "captureStatusWaiting": "Connecté — l'app est silencieuse",
            "captureStatusReconnecting": "Reconnexion audio…",
            "captureStatusPermission": "Pas d'audio — vérifiez l'autorisation",
            "openAudioRecordingSettings": "Ouvrir les réglages d'enregistrement audio",
            "audioInput": "Audio",
            "listening": "Écoute...",
        ...
        "ko": [
            ...
            "captureWaitingForSourceAudioFormat": "연결됨. %@ 에서 소리가 나기를 기다리는 중입니다. 회의를 시작하거나 음소거를 해제하세요.",
            "captureReconnectingHint": "오디오 경로가 바뀌었습니다. 다시 연결하는 중…",
            "capturePermissionProblemHintFormat": "%@ 이(가) 재생 중이지만 소리가 들어오지 않습니다. 시스템 설정 › 개인정보 보호 및 보안 › 화면 및 시스템 오디오 녹음에서 v2s를 허용한 뒤 v2s를 다시 시작하세요.",
            "captureStatusStarting": "시작하는 중…",
            "captureStatusHearing": "오디오 수신 중",
            "captureStatusWaiting": "연결됨 — 앱이 무음",
            "captureStatusReconnecting": "오디오 다시 연결 중…",
            "captureStatusPermission": "오디오 없음 — 권한 확인",
            "openAudioRecordingSettings": "오디오 녹음 설정 열기",
            "audioInput": "오디오",
            "listening": "듣는 중...",
        ...
        "ar": [
            ...
            "sourceSubtitleColor": "لون النص الأصلي",
            ...
            "captureWaitingForSourceAudioFormat": "متصل. بانتظار أن يُشغّل %@ الصوت — ابدأ الاجتماع أو ألغِ كتم السماعة.",
            "captureReconnectingHint": "تغيّر مسار الصوت. جارٍ إعادة الاتصال…",
            "capturePermissionProblemHintFormat": "يُشغّل %@ الصوت لكن لا يصل أي صوت. اسمح لـ v2s في إعدادات النظام › الخصوصية والأمان › تسجيل الشاشة وصوت النظام، ثم أعد تشغيل v2s.",
            "captureStatusStarting": "جارٍ البدء…",
            "captureStatusHearing": "يتم استقبال الصوت",
            "captureStatusWaiting": "متصل — التطبيق صامت",
            "captureStatusReconnecting": "جارٍ إعادة توصيل الصوت…",
            "captureStatusPermission": "لا يوجد صوت — تحقّق من الإذن",
            "openAudioRecordingSettings": "فتح إعدادات تسجيل الصوت",
            "audioInput": "الصوت",
        ...
        "pt": [
            ...
            "subtitleColor": "Cor da tradução",
            "sourceSubtitleColor": "Cor do texto original",
            ...
            "captureWaitingForSourceAudioFormat": "Conectado. Aguardando %@ reproduzir som — inicie a reunião ou ative o alto-falante.",
            "captureReconnectingHint": "A rota de áudio mudou. Reconectando…",
            "capturePermissionProblemHintFormat": "%@ está reproduzindo, mas nenhum som chega. Permita o v2s em Ajustes do Sistema › Privacidade e Segurança › Gravação de Tela e Áudio do Sistema e reinicie o v2s.",
            "captureStatusStarting": "Iniciando…",
            "captureStatusHearing": "Recebendo áudio",
            "captureStatusWaiting": "Conectado — o app está em silêncio",
            "captureStatusReconnecting": "Reconectando áudio…",
            "captureStatusPermission": "Sem áudio — verifique a permissão",
            "openAudioRecordingSettings": "Abrir ajustes de gravação de áudio",
            "audioInput": "Áudio",
            "listening": "Ouvindo...",
        ...
        "ru": [
            ...
            "subtitleColor": "Цвет перевода",
            "sourceSubtitleColor": "Цвет исходного текста",
            ...
            "captureWaitingForSourceAudioFormat": "Подключено. Ждём звука от %@ — начните встречу или включите звук.",
            "captureReconnectingHint": "Маршрут звука изменился. Переподключение…",
            "capturePermissionProblemHintFormat": "%@ воспроизводит звук, но он не поступает. Разрешите v2s в Системных настройках › Конфиденциальность и безопасность › Запись экрана и системного звука, затем перезапустите v2s.",
            "captureStatusStarting": "Запуск…",
            "captureStatusHearing": "Звук поступает",
            "captureStatusWaiting": "Подключено — приложение молчит",
            "captureStatusReconnecting": "Переподключение звука…",
            "captureStatusPermission": "Нет звука — проверьте разрешение",
            "openAudioRecordingSettings": "Открыть настройки записи звука",
            "audioInput": "Звук",
            "listening": "Слушает...",
